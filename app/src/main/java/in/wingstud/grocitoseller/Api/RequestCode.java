...
public class RequestCode {
    ...
    public static final int CODE_ForgetPassword=30;
    ...
    public static final int CODE_SellerAddBrand=35;
    public static final int CODE_UserGetProductItem=36;
    public static final int CODE_SellerUpdateItemQty=37;
    public static final int CODE_SellerChangePassword=38;
