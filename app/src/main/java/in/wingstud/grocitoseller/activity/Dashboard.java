...
import in.wingstud.grocitoseller.databinding.ActivityDashboardBinding;
import in.wingstud.grocitoseller.fragment.HelpSupport;
import in.wingstud.grocitoseller.fragment.Inventory;
import in.wingstud.grocitoseller.fragment.Notice;
import in.wingstud.grocitoseller.fragment.HomeFrag;
import in.wingstud.grocitoseller.fragment.NavMenuFrag;
import in.wingstud.grocitoseller.fragment.ProductUploadList;
import in.wingstud.grocitoseller.fragment.NewOrder;
import in.wingstud.grocitoseller.fragment.Payment;
import in.wingstud.grocitoseller.util.Constants;
...
public class Dashboard extends AppCompatActivity implements NavMenuFrag.FragmentDrawerListener {
    ...
    private void initialize() {
        ...
        binding.toolbar.imvNotification.setOnClickListener(view -> Utils.startActivity(mContext, NotificationActi.class));
...
//            }
        ...
        } else if (menuNmae.equalsIgnoreCase(mContext.getResources().getString(R.string.help_support))){
            fragment = new HelpSupport();
            if (!(fragcheck instanceof HelpSupport)) {
                loadHomeFragment();
            }
