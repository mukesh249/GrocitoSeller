...
import in.wingstud.grocitoseller.databinding.UpdateProductQtyPopupBinding;
...
import in.wingstud.grocitoseller.model.UserGetProductItemModel;
...
public class ProductListAdapter extends RecyclerView.Adapter<ProductListAdapter.ViewHolder> implements WebCompleteTask , Filterable {
    ...
    private void DeleteDupItem(int pos) {
        HashMap objectNew = new HashMap();
        objectNew.put("duplicate_id", arrayList.get(pos).getId());
