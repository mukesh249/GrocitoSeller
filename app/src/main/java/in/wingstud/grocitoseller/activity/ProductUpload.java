...
import in.wingstud.grocitoseller.Api.ApiConfig;
import in.wingstud.grocitoseller.Api.AppConfig;
...
import in.wingstud.grocitoseller.adapter.ColorListAdapter;
import in.wingstud.grocitoseller.adapter.PriceUnitAdapter;
import in.wingstud.grocitoseller.adapter.SearchItemAdapter;
import in.wingstud.grocitoseller.adapter.SelectImageAdapter;
import in.wingstud.grocitoseller.databinding.AddBrandPopupBinding;
import in.wingstud.grocitoseller.databinding.ProductUploadBinding;
import in.wingstud.grocitoseller.databinding.SearchPopupBinding;
import in.wingstud.grocitoseller.model.ColorModel;
import in.wingstud.grocitoseller.model.ImageModel;
import in.wingstud.grocitoseller.model.PriceUnitModel;
...
//                binding.cancelBt.setVisibility(View.VISIBLE);
    ...
    public void setFieldData(JSONObject dataObject) {
        ...
        if (Utils.checkEmptyNull(dataObject.optString("name")))
            binding.productNameEt.setText(dataObject.optString("name"));

        if (Utils.checkEmptyNull(dataObject.optString("description")))
            binding.productDesEt.setText(dataObject.optString("description"));

        if (Utils.checkEmptyNull(dataObject.optString("p_gst")))
...
//                        dismissProgressBar();
    ...
    public void getsearchData(SearchModel.Datum dataObject) {
        ...
        if (Utils.checkEmptyNull(dataObject.name))
            binding.productNameEt.setText(dataObject.name);

        if (Utils.checkEmptyNull(dataObject.description))
            binding.productDesEt.setText(dataObject.description);

        if (Utils.checkEmptyNull(dataObject.pGst))
