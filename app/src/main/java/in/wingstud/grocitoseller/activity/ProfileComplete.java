...
import in.wingstud.grocitoseller.adapter.MultipleDeliveryPincodeAdapter;
import in.wingstud.grocitoseller.databinding.ProfileCompleteBinding;
import in.wingstud.grocitoseller.fragment.ProfileFrag;
import in.wingstud.grocitoseller.model.SelectedPinModel;
import in.wingstud.grocitoseller.model.StateModel;
...
//
////            SharedPrefManager.setAddress(Constrants.DeliveryAddress,address);
//            binding.etAddressSign.setText(address);
//            center = place.getLatLng();
//            if (center!=null) {
//                lati = center.latitude;
//                longi = center.longitude;
...
//                                                               All_Book_List_Method();
                            ...
                            Utils.Toast(ProfileComplete.this, "Unable to find current location . Try again later");
                        }
                    }
            );
        }
