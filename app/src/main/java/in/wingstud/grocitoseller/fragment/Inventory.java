...
import in.wingstud.grocitoseller.adapter.InventoryAdapter;
import in.wingstud.grocitoseller.databinding.FragmentInventoryBinding;
...
public class Inventory extends Fragment implements WebCompleteTask {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.inStockTv.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        binding.outStockTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OutstcokMethod();
