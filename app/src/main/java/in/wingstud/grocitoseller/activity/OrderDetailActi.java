...
import in.wingstud.grocitoseller.adapter.OrderDetailAdapter;
import in.wingstud.grocitoseller.databinding.ActivityOrderDetailBinding;
...
public class OrderDetailActi extends AppCompatActivity implements WebCompleteTask {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.shippedOrdTv.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        if (RequestCode.CODE_PaidPaymentDetails == taskcode){
            ...
            try {
                ...
                if (jsonObject.getInt("status_code")==1){
                    ...
                    binding.RECAmtTv.setText(String.format("%.2f",dataObj.optDouble("rec_amount")));
