...
import in.wingstud.grocitoseller.databinding.ActivityRagistrationBinding;
    ...
    public void RegistrationApi() {
        ...
        if (TextUtils.isEmpty(binding.etFullName.getText().toString().trim())) {
           ...
           Utils.isEmpty(Registration.this,binding.etName.toString().trim(),"Business Name is Required");
            ...
            Utils.Tosat(Registration.this, "Please select state");
        } else if (TextUtils.isEmpty(city_id)) {
            Utils.Tosat(Registration.this, "Please select city");
        } else {
        ...
        if (RequestCode.CODE_Register == taskcode){
            ...
            try {
                ...
                if (jsonObject.getInt("status_code") == 1) {
                    ...
                    Utils.Tosat(Registration.this,mes);
                    finish();
                }else {
                    Utils.Tosat(Registration.this,jsonObject.optString("error_message"));
                }
